...
public class JsonObjectMapper {
    ...
    public List<Position> convertPositionInformation(String jsonString) throws JsonProcessingException {
        return objectMapper.readValue(jsonString, new TypeReference<LinkedList<Position>>() {
        });
    }

    public OrderBook convertOrderBook(String jsonString) throws JsonProcessingException {
        return objectMapper.readValue(jsonString, OrderBook.class);
