...
public class OrderStopMarket extends OrderService {
    ...
    public NewOrder newOrder(Symbol symbol,
        ...
        return newOrder(symbol, side, positionSide, OrderType.STOP_MARKET, quantity, null, null, stopPrice, TimeInForce.GTC);
    }
